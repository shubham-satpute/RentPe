                ...
                <>
                    <section className='mt-3  container'>
                        ...
                        <div className='d-flex justify-content-center mb-3 mt-2'>
                            <h2 className='mt-2 mb-2'>Existing Rooms</h2>
                        </div>
                        <Row>
                            ...
                            <Col md={2} className='mb-3 mb-md-0'>
                                <Link to={`/add-room`} class="btn btn-info" style={{ alignItems: 'center' }}><RiAddCircleFill /> Add new Room</Link>
                            </Col>
                        </Row>
                                    ...
                                    currentRooms.map((room) => {
                                        return (
                                            <tr key={room.id} className='text-center'>
                                                ...
                                                <td>
                                                    <Link to={`/room-details/${room.id}`} className="btn btn-primary ">
                                                        <GrView />
                                                    </Link>
                                                    <> </>
